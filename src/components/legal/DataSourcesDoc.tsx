...
> = {
  en: {
    ...
    photo: [
      ...
      "We then check those names against published US government nutrition tables. When the match is confident, we use those published calories and macros for the grams on your draft.",
    ...
    searchTitle: "Search",
    search:
      "Typed search uses the same published nutrition tables. About 13,600 foods. This is public data. We do not resell it.",
  ...
  pl: {
    ...
    updated: "Ostatnia aktualizacja: 9 września 2026",
    intro:
    ...
    photo: [
      ...
      "Te nazwy sprawdzamy z opublikowanymi tabelami żywieniowymi rządu USA. Przy pewnym dopasowaniu bierzemy opublikowane kalorie i makro na gramy z Twojego szkicu.",
    ...
    search:
      "Wpisane nazwy szukamy w tych samych opublikowanych tabelach. Około 13 600 produktów. To dane publiczne. Nie odsprzedajemy ich.",
  ...
  de: {
    ...
    updated: "Stand: 9. September 2026",
    intro:
    ...
    photo: [
      ...
      "Diese Namen gleichen wir mit veröffentlichten US-Nährwerttabellen ab. Bei einem sicheren Treffer nutzen wir die veröffentlichten Kalorien und Makros für die Gramm aus deinem Entwurf.",
    ...
    searchTitle: "Suche",
    search:
      "Getippte Suche nutzt dieselben veröffentlichten Nährwerttabellen. Etwa 13.600 Lebensmittel. Öffentliche Daten. Wir verkaufen sie nicht weiter.",
  ...
  es: {
    ...
    photo: [
      ...
      "Esos nombres se contrastan con tablas nutricionales publicadas del gobierno de EE. UU. Si el emparejamiento es fiable, usamos esas calorías y macros publicadas con los gramos de tu borrador.",
    ...
    search:
      "La búsqueda por texto usa las mismas tablas nutricionales publicadas. Unos 13.600 alimentos. Datos públicos. No los revendemos.",
