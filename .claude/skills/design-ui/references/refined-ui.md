...
**This repo:** the CSS `:root` examples below are **taste guidance**, not a file to create.
Use the design tokens that already exist in the project (see `.cursor/rules/project.mdc`).
Do not paste this palette into a new stylesheet or invent a second brand.
