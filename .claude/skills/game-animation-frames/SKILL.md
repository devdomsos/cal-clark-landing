...
Open `.cursor/skills/video2dsprite/SKILL.md` or `.cursor/skills/generate2dsprite/SKILL.md`
...
Read [image-tools.md](../game-asset-core/references/image-tools.md) first. Never invent `imagine_*`.
