...
## Stack adaptation (this repo)

You are in a **pnpm monorepo** (Next.js web, Expo mobile, optional game packages), not a bare HTML page and not a TanStack Start sandbox:
